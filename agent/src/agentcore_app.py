...
# Basic logging configuration - AgentCore handles ALL observability automatically
...
# AgentCore app instance - observability handled completely by AgentCore with strands-agents[otel]
